	...
	function aksi_login(){
		...
		if($level=='admin')
		{
			...
			if($cek > 0){
				...
				$this->session->set_flashdata('notif', '<div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Username atau Password tidak Valid , Silahkan Coba lagi.</div>');
				redirect('login');
			}
		}
		if($level=='guru')
