 ...
 */
    ...
    public function jadwal_guru()
    {
        ...
        $data['content'] = "admin/penjadwalan/v_jadwal_guru_mengajar";
        $this->load->view('admin/index', $data);
    }
 ...
 */
    ...
    public function penjadwalan_wali_kelas()
    {
        ...
        $data['content'] = "admin/penjadwalan/v_pembagian_wali_kelas";
        $this->load->view('admin/index', $data);
    }
 ...
 */
    ...
    public function form_tambah_walikelas()
    {
        ...
        include "pagination_config.php";
        //end Pagination::
        $data['content'] = "admin/penjadwalan/v_form_pembagian_wali_kelas";
        $this->load->view('admin/index', $data);
	}
	public function form_tambah_jadwalguru()
    {
		//Filtering data jadwal guru mengajar::
        if (isset($_POST['sort_jadwal_mengajar'])) {
            $id_kelas = trim($this->input->post('kelas'));
        ...
        include "pagination_config.php";
        //end Pagination::
        $data['content'] = "admin/penjadwalan/v_form_jadwal_guru";
        $this->load->view('admin/index', $data);
    }
