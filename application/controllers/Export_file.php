...
public function down_templateup_nilai()
	{
		...
		$dtpelajaran = $this->m_guru->select_dataWhere('id_pelajaran='.$id_pelajaran.'', 'setup_pelajaran');
		$nama_pelajaran = strtoupper($dtpelajaran->row('nama_pelajaran'));
		$nama_kelas = $this->m_guru->select_dataWhere('id_kelas='.$id_kelas.'', 'setup_kelas')->row('nama_kelas');
		$pd_tahun = $setup_tahun->tahun;
		...
		$excel->setActiveSheetIndex(0)->setCellValue('A1', "DATA NILAI $nama_pelajaran KELAS $nama_kelas TA $pd_tahun SEMESTER $semester"); // Set kolom A1 dengan tulisan "DATA SISWA"
		...
		$excel->setActiveSheetIndex(0)->setCellValue('E3', "NILAI PENGETAHUAN");
		$excel->setActiveSheetIndex(0)->setCellValue('F3', "NILAI KETRAMPILAN");
		...
		foreach($sql->result_array() as $data){ // Ambil semua data dari hasil eksekusi $sql
		  ...
		  $excel->setActiveSheetIndex(0)->setCellValue('E'.$numrow, $data['nilai_pengetahuan']);
		  $excel->setActiveSheetIndex(0)->setCellValue('F'.$numrow, $data['nilai_ketrampilan']);
		...
		$excel->getActiveSheet()->getStyle('E4:F'.$numRows.'')->getProtection()->setLocked(PHPExcel_Style_Protection::PROTECTION_UNPROTECTED);
	}else{
		...
		foreach($sql->result_array() as $data){ // Ambil semua data dari hasil eksekusi $sql
		  ...
		  $excel->setActiveSheetIndex(0)->setCellValue('D'.$numrow, $nilai_pengetahuan);
		  $excel->setActiveSheetIndex(0)->setCellValue('E'.$numrow, $nilai_ketrampilan);
		...
		$excel->getActiveSheet()->getProtection()->setInsertRows(true);
		$excel->getActiveSheet()->getProtection()->setFormatCells(true);
		$excel->getActiveSheet()->getStyle('D4:E'.$numRows.'')->getProtection()->setLocked(PHPExcel_Style_Protection::PROTECTION_UNPROTECTED);
	}
	...
	public function down_templateup_deskripsi()
	{
		...
		$excel->setActiveSheetIndex(0)->setCellValue('A1', "DESKRIPSI NILAI $nama_pelajaran KELAS $nama_kelas TA $pd_tahun SEMESTER $semester"); // Set kolom A1 dengan tulisan "DATA SISWA"
		...
		$excel->setActiveSheetIndex(0)->setCellValue('D3', "NAMA");
		$excel->getActiveSheet()->mergeCells('D3:D4'); // Set Merge Cell
		$excel->setActiveSheetIndex(0)->setCellValue('E3', "ASPEK PENGETAHUAN");
		$excel->getActiveSheet()->mergeCells('E3:F3'); // Set Merge Cell
		$excel->setActiveSheetIndex(0)->setCellValue('E4', "Nilai");
		$excel->setActiveSheetIndex(0)->setCellValue('F4', "Deskripsi");
		$excel->setActiveSheetIndex(0)->setCellValue('G3', "ASPEK KETRAMPILAN");
		...
		foreach($sql->result_array() as $data){ // Ambil semua data dari hasil eksekusi $sql
		  ...
		  $excel->setActiveSheetIndex(0)->setCellValue('B'.$numrow, $data['idnilai']);
		  //$excel->setActiveSheetIndex(0)->setCellValue('D'.$numrow, $data['idpelajaran']);
		  $excel->setActiveSheetIndex(0)->setCellValue('C'.$numrow, $data['nilai_nis']);
		  $excel->setActiveSheetIndex(0)->setCellValue('D'.$numrow, $data['nama_siswa']);
		  $excel->setActiveSheetIndex(0)->setCellValue('E'.$numrow, $data['nilai_pengetahuan']);
		  $excel->setActiveSheetIndex(0)->setCellValue('F'.$numrow, $data['pengetahuan']);
		  $excel->setActiveSheetIndex(0)->setCellValue('G'.$numrow, $data['nilai_ketrampilan']);
		  $excel->setActiveSheetIndex(0)->setCellValue('H'.$numrow, $data['ketrampilan']);
		...
		$excel->getActiveSheet()->getProtection()->setInsertRows(true);
		$excel->getActiveSheet()->getProtection()->setFormatCells(true);
		$excel->getActiveSheet()->getStyle('F5:F'.$numRows.'')->getProtection()->setLocked(PHPExcel_Style_Protection::PROTECTION_UNPROTECTED);
		$excel->getActiveSheet()->getStyle('H5:H'.$numRows.'')->getProtection()->setLocked(PHPExcel_Style_Protection::PROTECTION_UNPROTECTED);
	...
	public function down_templateup_sikap()
	{
		...
		$excel->setActiveSheetIndex(0)->setCellValue('D3', "SIKAP SPIRITUAL");
		$excel->getActiveSheet()->mergeCells('D3:E3'); // Set Merge Cell
		$excel->setActiveSheetIndex(0)->setCellValue('D4', "Predikat");
		$excel->setActiveSheetIndex(0)->setCellValue('E4', "Deskripsi");
		$excel->setActiveSheetIndex(0)->setCellValue('F3', "SIKAP SOSIAL");
		$excel->getActiveSheet()->mergeCells('F3:G3'); // Set Merge Cell
		$excel->setActiveSheetIndex(0)->setCellValue('F4', "Predikat");
		...
		foreach($sql->result_array() as $data){ // Ambil semua data dari hasil eksekusi $sql
		  ...
		  $excel->setActiveSheetIndex(0)->setCellValue('D'.$numrow, $data['predikat_spiritual']);
		  $excel->setActiveSheetIndex(0)->setCellValue('E'.$numrow, $data['sikap_spiritual']);
		  $excel->setActiveSheetIndex(0)->setCellValue('F'.$numrow, $data['predikat_sosial']);
		  $excel->setActiveSheetIndex(0)->setCellValue('G'.$numrow, $data['sikap_sosial']);
		...
		$excel->getActiveSheet()->getProtection()->setInsertRows(true);
		$excel->getActiveSheet()->getProtection()->setFormatCells(true);
		$excel->getActiveSheet()->getStyle('D5:G'.$numRows.'')->getProtection()->setLocked(PHPExcel_Style_Protection::PROTECTION_UNPROTECTED);
		}
		else
		{
		// Buat header tabel nya pada baris ke 3
