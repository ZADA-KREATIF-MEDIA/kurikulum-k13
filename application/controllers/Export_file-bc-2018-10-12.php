...
public function down_templateup_nilai()
	{
		...
		$excel->setActiveSheetIndex(0)->setCellValue('C3', "NILAI PENGETAHUAN");
		$excel->setActiveSheetIndex(0)->setCellValue('D3', "NILAI KETRAMPILAN");
		...
		foreach($sql->result_array() as $data){ // Ambil semua data dari hasil eksekusi $sql
		  ...
		  $excel->setActiveSheetIndex(0)->setCellValue('C'.$numrow, $nilai_pengetahuan);
		  $excel->setActiveSheetIndex(0)->setCellValue('D'.$numrow, $nilai_ketrampilan);
		...
		$excel->getActiveSheet()->getProtection()->setInsertRows(true);
		$excel->getActiveSheet()->getProtection()->setFormatCells(true);
		$excel->getActiveSheet()->getStyle('C4:D'.$numRows.'')->getProtection()->setLocked(PHPExcel_Style_Protection::PROTECTION_UNPROTECTED);
	}
	...
	public function down_templateup_deskripsi()
	{
		...
		$excel->setActiveSheetIndex(0)->setCellValue('D3', "ASPEK PENGETAHUAN");
		...
		$excel->setActiveSheetIndex(0)->setCellValue('F3', "ASPEK KETRAMPILAN");
		...
		foreach($sql->result_array() as $data){ // Ambil semua data dari hasil eksekusi $sql
		  ...
		  $excel->setActiveSheetIndex(0)->setCellValue('D'.$numrow, $data['nilai_pengetahuan']);
		  $excel->setActiveSheetIndex(0)->setCellValue('E'.$numrow, $data['pengetahuan']);
		  $excel->setActiveSheetIndex(0)->setCellValue('F'.$numrow, $data['nilai_ketrampilan']);
		  $excel->setActiveSheetIndex(0)->setCellValue('G'.$numrow, $data['ketrampilan']);
		...
		$excel->getActiveSheet()->getProtection()->setInsertRows(true);
		$excel->getActiveSheet()->getProtection()->setFormatCells(true);
		$excel->getActiveSheet()->getStyle('E5:E'.$numRows.'')->getProtection()->setLocked(PHPExcel_Style_Protection::PROTECTION_UNPROTECTED);
	...
	public function down_templateup_sikap()
	{
		...
		$excel->setActiveSheetIndex(0)->setCellValue('C3', "SIKAP SPIRITUAL");
		$excel->getActiveSheet()->mergeCells('C3:D3'); // Set Merge Cell
		$excel->setActiveSheetIndex(0)->setCellValue('C4', "Predikat");
		$excel->setActiveSheetIndex(0)->setCellValue('D4', "Deskripsi");
		$excel->setActiveSheetIndex(0)->setCellValue('E3', "SIKAP SOSIAL");
		$excel->getActiveSheet()->mergeCells('E3:F3'); // Set Merge Cell
		$excel->setActiveSheetIndex(0)->setCellValue('E4', "Predikat");
		...
		foreach($sql->result_array() as $data){ // Ambil semua data dari hasil eksekusi $sql
		  ...
		  $excel->setActiveSheetIndex(0)->setCellValue('C'.$numrow, $data['predikat_spiritual']);
		  $excel->setActiveSheetIndex(0)->setCellValue('D'.$numrow, $data['sikap_spiritual']);
		  $excel->setActiveSheetIndex(0)->setCellValue('E'.$numrow, $data['predikat_sosial']);
		  $excel->setActiveSheetIndex(0)->setCellValue('F'.$numrow, $data['sikap_sosial']);
		...
		$excel->getActiveSheet()->getProtection()->setInsertRows(true);
		$excel->getActiveSheet()->getProtection()->setFormatCells(true);
		$excel->getActiveSheet()->getStyle('C5:F'.$numRows.'')->getProtection()->setLocked(PHPExcel_Style_Protection::PROTECTION_UNPROTECTED);
		}
		else
		{
		// Buat header tabel nya pada baris ke 3
