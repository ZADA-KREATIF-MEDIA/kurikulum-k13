  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <div class="form-group col-md-12 col-sm-12">
        ...
        <input type="text" class="form-control" id="ttl" name="tempat_lahir" value="<?= $siswa['tempat_lahir']; ?>" readonly>
      </div>
      <div class="form-group col-md-12 col-sm-12">
        <label for="tgl_lahir">Tanggal Lahir</label>
        <input type="date" class="form-control" id="tgl_lahir" name="tgl_lahir" value="<?= $siswa['tgl_lahir']; ?>" readonly>
      </div>
      <div class="form-group col-md-12 col-sm-12">
        <label for="kelamin">Jenis Kelamin</label>
        <select name="kelamin" class="form-control" disabled>
          <option value="L" <?php if ($siswa['kelamin'] == "L") {
                              echo "selected";
                            } ?>>Laki-laki</option>
          <option value="P" <?php if ($siswa['kelamin'] == "P") {
                              echo "selected";
                            } ?>>Perempuan</option>
        </select>
      </div>
      <div class="form-group col-md-12 col-sm-12">
        ...
        <select name="agama" id="" class="form-control" disabled>
          ...
          <option value="kristen" <?php if ($siswa['agama'] == "kristen") {
                                    echo "selected";
                                  } ?>>Kristen</option>
          <option value="katholik" <?php if ($siswa['agama'] == "katholik") {
                                      echo "selected";
                                    } ?>>Katholik
          </option>
          <option value="budha" <?php if ($siswa['agama'] == "budha") {
                                  echo "selected";
                                } ?>>Budha</option>
      ...
      <div class="form-group col-md-12 col-sm-12">
        ...
        <select name="status_dlm_kel" class="form-control" disabled>
          <option value="Anak Kandung" <?php if ($siswa['status_dlm_kel'] == "Anak Kandung") {
                                          echo "selected";
                                        } ?>>
            Anak Kandung</option>
          <option value="Anak Angkat" <?php if ($siswa['status_dlm_kel'] == "Anak Angkat") {
                                        echo "selected";
                                      } ?>>
            Anak Angkat</option>
        </select>
      ...
      <div class="form-group col-md-12 col-sm-12">
        ...
        <input type="text" class="form-control" name="telpon_siswa" value="<?= $siswa['telpon_siswa']; ?>" readonly>
      </div>
      <div class="form-group col-md-12 col-sm-12">
        <label for="asal_sekolah">Asal Sekolah</label>
        <input type="text" class="form-control" name="asal_sekolah" value="<?= $siswa['asal_sekolah']; ?>" readonly>
      </div>
    </div>
    <div class="col-md-6">
      <div class="form-group col-md-12 col-sm-12">
      ...
      <div class="form-group col-md-12 col-sm-12">
        ...
        <input type="text" class="form-control" name="telpon_ortu" value="<?= $siswa['telpon_ortu']; ?>" readonly>
      </div>
      <div class="form-group col-md-12 col-sm-12">
        <label for="almt_ortu">Alamat Ortu</label>
        <input type="text" class="form-control" name="alamat_ortu" value="<?= $siswa['alamat_ortu']; ?>" readonly>
      </div>
      <div class="form-group col-md-12 col-sm-12">
      ...
      <div class="form-group col-md-12 col-sm-12">
        ...
        <input type="text" class="form-control" name="telpon_wali" value="<?= $siswa['telpon_wali']; ?>" readonly>
      </div>
      <div class="form-group col-md-12 col-sm-12">
        <label for="alamat_wali">Alamat Wali</label>
        <input type="text" class="form-control" name="alamat_wali" value="<?= $siswa['alamat_wali']; ?>" readonly>
      </div>
    </div>
  </div>
  <hr>
    ...
    <div class="col-md-12">
      ...
      <table width="100%" cellspacing="0" cellpadding="2" border="1">
        <tbody>
          ...
          <?php
          $noA = 1;
          foreach ($nilai_rapor as $rownilai) {
