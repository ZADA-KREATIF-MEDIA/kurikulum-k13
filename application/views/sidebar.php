                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="master">
                        <ul class="nav flex-column sub-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?= base_url() ?>admin_editnilai/edit_sikap?m=edit_nilai&sm=edit_sikap">Kompentensi
                                    Sikap</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?= base_url() ?>/admin_editnilai/edit_nilai_peng_ketr?m=edit_nilai&sm=pengetahuan_ketrampilan">Kompentensi
                                    Pengetahuan <br>Dan
                                    Ketrampilan</a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?= base_url() ?>admin_editnilai/edit_data_kehadiran">Ketidakhadiran</a>
                            </li>
