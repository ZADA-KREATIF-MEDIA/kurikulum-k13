 ...
 <section class="content">
      ...
      <!-- Sortir Data-->
		 ...
		 <div class="box">
            ...
            <div class="box-body">
            	<div class="col-md-12">
                <form class="form-inline" method="post" action="<?php echo base_url('guru/laporan_legger_semua?m=laporan_nilai&sm=legger_semua/');?>">
        ...
        <tr>
          ...
          <td><a href="<?php echo base_url('guru/detail_siswa/'.$row['nis'].'?m=laporan_nilai&sm=detail_siswa');?>"><?php echo $row['nama_siswa'];?></a></td>
