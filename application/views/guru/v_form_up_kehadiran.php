              ...
              <div class="box">
               ...
               <table   class="table table-hover table-bordered">
				...
				if($this->session->userdata('status')=="admin")
					{?>
				 &nbsp;  -  &nbsp;<a  onclick="return confirm('Data belum disimpan,apakah Anda yakin batal?')" href="<?php echo base_url('admin_editnilai/edit_data_kehadiran?m=edit_nilai&sm=data_kehadiran');?>" button class="btn btn-danger"/><small class="glyphicon glyphicon-chevron-left"></small> Batal</a>
				 <?php
