				   ...
				   <?php
						...
						foreach($catatanwk->result_array() as $row){
							...
							<tr>
								...
								<td class="bg-primary text-white"><?php echo "<textarea class=\"form-control\" cols='50' name='catatanwk".$i."' placeholder='Berikan catatan'>".$row['catatanwk']."</textarea>";?></td>
							</tr>
							<?php
							$i++;
						}
                    ...
                    <tr>
                      ...
                      <td colspan="4"> &nbsp; &nbsp;   <input type="hidden" name="jumlah" value="<?php echo $jumSis ?>" /><input type="submit" value="Simpan" name="update" class="btn btn-primary"/> 
