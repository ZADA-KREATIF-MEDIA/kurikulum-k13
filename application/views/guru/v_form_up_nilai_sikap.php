						...
						foreach($nilai_sikap->result_array() as $row){
							...
							<tr>
								...
								<td><?php echo "<select class=\"form-control\" name='a".$i."'>"; ?>
									<option value="A" <?php if($row['predikat_spiritual']=="A"){echo "selected";}?>>A</option>
									<option value="B" <?php if($row['predikat_spiritual']=="B" OR $row['predikat_spiritual']==""){echo "selected";}?>>B</option>
								...
								<td><?php echo "<select class=\"form-control\" name='c".$i."'>"; ?>
									<option value="A" <?php if($row['predikat_sosial']=="A"){echo "selected";}?>>A</option>
									<option value="B" <?php if($row['predikat_sosial']=="B" OR $row['predikat_sosial']==""){echo "selected";}?>>B</option>
  ...
  <div class="modal fade" id="modal-default-up">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <form method="post" action="<?php echo base_url('import_excel/do_importup_sikap');?>" enctype="multipart/form-data" accept-charset="utf-8">
