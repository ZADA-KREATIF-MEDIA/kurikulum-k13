...
<div class="page-break"></div>
 ...
 <b>Deskripsi Pengetahuan dan Ketrampilan</b><br><br>
  ...
  <tbody>
    ...
    <?php 
      $iA = 1;
    foreach($deskripsi_nilai->result() as $rowdes){
...
<b>Catatan Wali Kelas</b><br>
  ...
  <tbody>
    <tr>
      <td><?php echo strip_tags($catatan_wk->row('catatanwk'));?><br><br></td>
    </tr>
...
<br>
  ...
  <tbody>
    <tr>
      <td>Mengetahui:</td><td width="50%">&nbsp;</td><td><?php echo strip_tags($kepsek->tgl_rapor);?></td>
    </tr>
    <tr>
      <td>Orang Tua/Wali</td><td>&nbsp;</td><td>Wali Kelas,</td>
    </tr>
     <tr>
      <td><br><br><br><br><br><br><br><br><br></td><td>&nbsp;</td><td><b><?php echo strip_tags($wali_kelas->nama_guru);?></b><br>NBM. <?php echo strip_tags($wali_kelas->nip);?></td>
    </tr>
