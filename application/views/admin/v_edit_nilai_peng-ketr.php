...
?>
 ...
 <section class="content">
   ...
   <div class="box">
            ...
            <div class="box-body">
              	<form action="<?php echo base_url('admin_editnilai/edit_nilai_peng_ketr');?>" method="post" class="form-horizontal">
...
if($mode_form=='update'){?>
      ...
      <div class="box">
        ...
        <form id="mainform" action="<?php echo base_url('admin_editnilai/proses_input_nilai');?>" method="post">
           ...
           <?php
            ...
            &nbsp;  -  &nbsp;<a  onclick="return confirm('Perubahan belum disimpan,apakah Anda yakin batal mengubah?')" href="<?php echo base_url('admin_editnilai/edit_nilai_peng_ketr?m=edit_nilai&sm=nilai_peng_ketr');?>" button class="btn btn-danger"/><small class="glyphicon glyphicon-chevron-left"></small> Batal</a>
            </td>
                    </tr>
  ...
  {?>
   ...
   <div class="box">
        ...
        <form id="mainform" action="<?php echo base_url('admin_editnilai/proses_input_nilai');?>" method="post" class="form-inline">
                <div class="box-body no-padding table-responsive">
                  <table class="table table-striped table-hover">
                    <tr>
                      <th>No</th>
           ...
           <?php
            ...
            foreach($nilai_pk->result_array() as $row){
              ...
              <tr>
                ...
                <td><?php echo $row['nis'];?></td>
                <td><?php echo $row['nama_siswa'];?></td>
                <td><?php echo "<input  class=\"form-control\" type='text' name='nilai_pengetahuan[]' size='4' />"; ?></td>
                <td><?php echo "<input  class=\"form-control\" type='text' name='nilai_ketrampilan[]' size='4' />"; ?></td>
              </tr>
              <?php
            ...
            ?>
                    ...
                    <tr>
                      ...
                      <td> &nbsp; &nbsp;   
                        ...
                        <div class="form-group">
                        <input type="hidden" name="jumlah" value="<?php echo $jumSis ?>" /><input type="submit" value="Simpan" name="input_nilai" class="btn btn-primary"/> 
                        </div>
            &nbsp;  -  &nbsp;<a  onclick="return confirm('Perubahan belum disimpan,apakah Anda yakin batal mengubah?')" href="<?php echo base_url('admin_editnilai/edit_nilai_peng_ketr?m=edit_nilai&sm=nilai_peng_ketr');?>" button class="btn btn-danger"/><small class="glyphicon glyphicon-chevron-left"></small> Batal</a>
            </td>
                    </tr>
