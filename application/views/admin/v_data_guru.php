...
<div class="box">
    ...
    <div class="box-body">
        ...
        ?>
                            <tr>
                                <td>
                                    <div class="checkbox icheck"><input type="checkbox" name="check[]"
                                            value="<?php echo $row['id_guru'] ;?>"></div>
                                </td>
                                <td><?php echo $no++;?></td>
                                ...
                                <td><a href="<?php echo base_url('admin/edit_guru/'.$row['id_guru'].'?m=data_induk&sm=guru');?>"
                                        class="btn btn-dark" title="Edit"> <i class="fa fa-edit"></i> </a> &nbsp;
                                    <a href="<?php echo base_url('admin/drop_guru/'.$row['id_guru'].'');?>"
        ...
        ?>
                    ...
                    <button class="btn btn-danger btn-sm" type="submit" name="multidelete"
                        onclick="return konfirmasi();"><i class="fa fa-trash"></i> Hapus Data Guru</button>
                    <br><br>
                </div>
                <!--  end product-table................................... -->
            </form>
