...
<table width="100%" cellspacing="0" cellpadding="2" border="1">
  ...
  <tr>
    <td align="center" valign="middle">&nbsp;<?php echo $predikat_spiritual;?></td><td align="left" valign="middle"><?php echo $sikap_spiritual;?></td>
  </tr>
</table>
<br>
...
<table width="100%" cellspacing="0" cellpadding="2" border="1">
  ...
  <tr>
    <td align="center" valign="middle"><?php echo $predikat_sosial;?></td><td align="left" valign="middle"><?php echo $sikap_sosial;?></td>
  </tr>
</table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="center" valign="middle">
        <?php if($rownilai->nilai_pengetahuan<73){echo "D";}
        elseif($rownilai->nilai_pengetahuan>=73&&$rownilai->nilai_pengetahuan<=81){echo "C";}
        elseif($rownilai->nilai_pengetahuan>=82&&$rownilai->nilai_pengetahuan<=90){echo "B";}
          ...
          foreach($nilai_rapor->result() as $subrownilai){
            ...
            {?>
               <tr>
                ...
                <td align="center" valign="middle">
                  <?php if($subrownilai->nilai_pengetahuan<73){echo "D";}
                  elseif($subrownilai->nilai_pengetahuan>=73&&$subrownilai->nilai_pengetahuan<=81){echo "C";}
                  elseif($subrownilai->nilai_pengetahuan>=82&&$subrownilai->nilai_pengetahuan<=90){echo "B";}
                  elseif($subrownilai->nilai_pengetahuan>=91&&$subrownilai->nilai_pengetahuan<=100){echo "A";}
                  ?></td>
...
<table width="100%" cellspacing="0" cellpadding="2" border="1">
  <tbody>
    ...
    <tr>
      ...
      <td align="center" valign="middle">
        <?php if($rownilai->nilai_ketrampilan<73){echo "D";}
        elseif($rownilai->nilai_ketrampilan>=73&&$rownilai->nilai_ketrampilan<=81){echo "C";}
        elseif($rownilai->nilai_ketrampilan>=82&&$rownilai->nilai_ketrampilan<=90){echo "B";}
          ...
          foreach($nilai_rapor->result() as $subrownilai){
            ...
            {?>
               <tr>
                ...
                <td align="center" valign="middle">
                  <?php if($subrownilai->nilai_ketrampilan<73){echo "D";}
                  elseif($subrownilai->nilai_ketrampilan>=73&&$subrownilai->nilai_ketrampilan<=81){echo "C";}
                  elseif($subrownilai->nilai_ketrampilan>=82&&$subrownilai->nilai_ketrampilan<=90){echo "B";}
                  elseif($subrownilai->nilai_ketrampilan>=91&&$subrownilai->nilai_ketrampilan<=100){echo "A";}
                  ?></td>
...
<b>Tabel interval predikat berdasarkan KKM</b><br>
  <table width="100%" cellspacing="0" cellpadding="2" border="1">
    <tbody>
      ...
      <tr>
        <td align="center">73</td><td align="center">< 73</td><td align="center">73 <= C <= 81 </td><td align="center">82 <= B <= 90 </td><td align="center"> 91 <= A <= 100 </td>
      </tr>
    </tbody>
  </table>
...
<table width="100%" cellspacing="0" cellpadding="2" border="1">
  <tbody>
    ...
    <tr>
      ...
      $nis = $this->db->escape($siswa->nis); $idkelas = $this->db->escape($kelas->id_kelas); $idtahun = $this->db->escape($tahun_ajaran->id_tahun); $idsms = $this->db->escape($semester->id_semester);
...
<table width="" cellspacing="0" cellpadding="2" border="1">
  <tbody>
    <tr>
      <td width="170px">Sakit</td><td width="200px">: 
