		...
		<div class="col-xs-12">
			<div class="box">
				<div class="box-header">
					<h3 class="box-title text-blue">Input Prestasi Siswa <small class=" glyphicon glyphicon-chevron-right"></small> Kelas: <?php echo $nama_kelas; ?> </h3>
				</div><!-- /.box-header -->
				<div class="box-body">
					<form method="post" action="<?php echo base_url('admin_editnilai/simpan_prestasi_siswa'); ?>" class="form-horizontal">
						<div class="form-group">
							...
							<div class="col-md-5">
								...
								<input type="hidden" name="back_url" value="<?php echo uri_string() . '/?set=update&m=edit_nilai&sm=prestasi'; ?>" />
						...
						<div class="form-group">
							...
							<div class="col-md-5">
								...
								<a href="<?php echo base_url('admin_editnilai/edit_prestasi?m=edit_nilai&sm=prestasi'); ?>" class="btn btn-primary btn-md">Kembali</a>
							</div>
						</div>
