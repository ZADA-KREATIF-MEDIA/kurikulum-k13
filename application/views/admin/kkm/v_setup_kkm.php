               ...
               if(!empty($type_form) && $type_form=="update"){?>
				...
				?>
                            <tr>
                                ...
                                <td><input type="hidden" name="idpelajaran[]"
                                        value="<?php echo $row['id_pelajaran'];?>"><?php echo $row['nama_pelajaran'];?>
                                </td>
                                <td><input type="hidden" name="kategori_kls[]"
                                        value="<?php echo $row['kategori_kls'];?>"><?php echo $row['kategori_kls'];?>
                                </td>
                                <td><input type="text" name="kkm[]" value="<?php echo $row['kkm'];?>"
        ...
        if($mapel_notset->num_rows()>0)
        {
          foreach($mapel_notset->result() as $mpl){?>
                            <tr bgcolor="#f3f3f3">
                                ...
                                <td><input type="hidden" class="form-control" name="idpelajaran2[]"
                                        value="<?php echo $mpl->id_pelajaran;?>"><?php echo $mpl->nama_pelajaran;?></td>
                                <td><input type="hidden" name="kategori_kls2[]"
                                        value="<?php echo $kategori_kls;?>"><?php echo $kategori_kls;?></td>
