...
?>
 ...
 <section class="content">
   ...
   <div class="box">
            ...
            <div class="box-body">
              	<form action="<?php echo base_url('admin_editnilai/form_edit_deskripsi');?>" method="post" class="form-horizontal">
                  <div class="form-group">
                    <label for="mapel" class="col-md-3 control-label">Mata Pelajaran</label>
                    <div class="col-md-5">
                      <select name="id_pelajaran"  class="form-control select2" >
                        <?php
