...
<section class="content">
      ...
      <div class="row">
          ...
          <div class="box">
                ...
                <div class="box-body">
                <form method="post" action="<?php echo base_url('admin_editnilai/simpan_nilai_ekstra');?>" class="form-horizontal">
					...
					<input type="hidden" name="back_url" value="<?php echo uri_string().'/?set=update&m=edit_nilai&sm=nilai_ekstra';?>" />
	                ...
	                <div class="form-group">
	                	...
	                	else
	                	{
	                		...
	                		foreach($nilai_ekstra->result() as $ne)
	                		{
	                			...
	                			<div class=\"col-md-4\"><a href='".base_url('admin_editnilai/hapus_ekstra_siswa/'.$ne->id_ekst.'/?back='.uri_string().'?set=update&m=edit_nilai&sm=nilai_ekstra')."' class='btn btn-md btn-danger' onclick='return konfirmasi();'><i class='fa fa-trash'></i> Hapus Ekstra Kurikuler $i</a></div>
	                	...
	                	<div class="form-group">
	                		...
	                		<div class="col-md-5">
	                			...
	                			<a href="<?php echo base_url('admin_editnilai/form_edit_ekstrakurikuler?m=edit_nilai&sm=nilai_ekstra');?>" class="btn btn-primary btn-md">Kembali</a>
	                		</div>
	                	</div>
