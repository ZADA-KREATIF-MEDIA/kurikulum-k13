...
$row = $data_guru->row();?>
  <section class="content">
      ...
      <div class="box">
          ...
          <div class="box-body">
              <form action="<?php echo base_url('admin/update_guru');?>" method="post" class="form-horizontal"
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-md-5">
                          <textarea class="form-control" name="alamat"
                              placeholder="alamat lengkap"><?php echo $row->alamat_guru;?></textarea>
                      </div>
                  </div>
                  <div class="form-group">
              ...
              <form method="post" action="<?php echo base_url('admin/reset_password_guru');?>" class="form-horizontal">
                  <div class="form-group">
                      ...
                      <div class="col-md-5">
                          ...
                          <button class="btn btn-danger" type="submit"><i class="fa fa-refresh"></i> Reset
                              Password</button>
                      </div>
                  </div>
              </form>
