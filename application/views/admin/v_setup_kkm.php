...
TOTAL : 0 DATA
		 ...
		 <div class="box">
          ...
          <input type="hidden" name="idtahun[]" value="<?php echo $row['id_tahun'];?>">
					<td><input type="hidden" name="idpelajaran[]" value="<?php echo $row['id_pelajaran'];?>"><?php echo $row['nama_pelajaran'];?></td>
          <td><input type="hidden" name="kategori_kls[]" value="<?php echo $row['kategori_kls'];?>"><?php echo $row['kategori_kls'];?></td>
        ...
        ?>
				...
				<button class="btn btn-primary btn-sm" type="submit" name="update"><i class="fa fa-save"></i> SIMPAN PERUBAHAN</button>
				<br><br>
				</div>
				<!--  end product-table................................... --> 
				</form>
        ...
        <button class="btn btn-primary btn-sm" type="submit" name="input"><i class="fa fa-save"></i> SIMPAN</button>
        <br><br>
      </table>
        </div>
        <!--  end product-table................................... --> 
